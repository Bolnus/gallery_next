...
import { AlbumsListState } from "./albumsListTypes";
import { Album, DefinedTag, GalleryImage } from "../../../shared/lib/common/galleryTypes";
import { AppDispatch, RootState, SliceActions } from "../../../appFSD/lib/redux/reduxStore";
import { getAlbumsList } from "../../../shared/api/albumsList/albumsListApi";
import { getAllTags } from "../../../shared/api/tags/tagsApi";
...
> {
  return async function (dispatch: AppDispatch) {
    ...
    if (tagsResponse.rc === 200 && tagsResponse.data) {
